...
PS1='\033[1;35m\u@ \033[1;0m[\033[1;31m$(__git_ps1 " %s")\033[0m \033[1;37m$PWD\033[0m ]\n $ '
...
export PATH=/usr/local/Cellar/php\@7.2/7.2.25/bin:$PATH
...
#export GOPATH=/Users/jim/work
#export PATH=$GOPATH/bin:$PATH
export PATH=/Users/jim/work/bin:$PATH
#export GOBIN=$GOPATH/bin
